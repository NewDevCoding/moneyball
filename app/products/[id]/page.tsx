        ...
        <div className="flex-1 flex flex-col">
          <div className="flex justify-between items-start gap-5 flex-wrap pb-6">
            ...
            <div className="flex flex-col gap-3">
              <p className="test-[20px] text-secondary font-semibold">{product.title}</p>
            ...
            <div className="flex items-center gap-3">
              <div className="product-hearts">
                <Image 
                  ...
                  width={20}
                />
                <p className="text-base font-semibold tet-[#D46F77]">{product.reviewsCount}</p>
          ...
          <div className="product-info">
            <div className="flex flex-col gap-2">
              <p className="text-[34px] text-secondary folt-bold">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-sm text-black opacity-50">
                <span className="text-primary-green font-semibold">93%</span> of buyers have recommmended this
              </p>
            </div>
          </div>     
